...
| Live Telegram | A new owner DM voice event was captured after the reset boundary and received exactly one linked delivered reply; the owner confirmed it was clear and appeared once. A subsequent owner note in the configured group was captured, received an `intentional_silence` decision and a skipped workflow, and had no delivered group bot message through the observation window. The note differed from the suggested sentence by one missing initial character. The voice capture-to-delivery time was 224.844 seconds; its relationship to the earlier 86.453-second pre-reset group turn is not causal evidence. | Run fresh private/group isolation, non-owner human reply/reaction, approval, retirement, correction, and recovery checks. Investigate the voice delay. [Voice evidence](compatibility/results/2026-09-25-post-reset-owner-voice.json), [silence evidence](compatibility/results/2026-09-25-post-reset-group-silence.json) |
