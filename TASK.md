...
| Inngest workflows | I1 infrastructure/recovery and I2 outbox, registry, receipts, and existing service job-operation fences verified in isolated Compose. Connect product functions, native/host runner fences, worker health and remaining I2–I7 work are pending; no active family switched. | [Foundation evidence](compatibility/results/2026-09-12-inngest-foundation.json), [Outbox evidence](compatibility/results/2026-09-12-inngest-outbox.json), [Job-operation evidence](compatibility/results/2026-09-12-inngest-job-operations.json), [execution plan](docs/workflow-monitoring-plan.md) |
