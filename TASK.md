...
| Inngest workflows | I1 infrastructure, pinned Connect compatibility, and quiesced inactive recovery verified in isolated Compose. Product function registration/worker health and I2–I7 remain pending; no active family switched. | [Foundation evidence](compatibility/results/2026-09-12-inngest-foundation.json), [ADR-0041](docs/adr/0041-local-inngest-workflows.md), [execution plan](docs/workflow-monitoring-plan.md) |
