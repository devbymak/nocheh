...
import {Activity as ActivityIcon,Archive as ArchiveIcon,BrainCircuit,Database,FolderInput,FolderKanban,Share2,GitFork,Home,Menu,Network,PanelLeftClose,PanelLeftOpen,Plug,RefreshCw,Settings as SettingsIcon,ShieldCheck,Users,Wrench,X} from 'lucide-react';
...
const groups=[['Knowledge',['overview','archive','learned','entities','memoryMap','memory','honcho','graph']],['Operations',['monitoring','activity']],['Manage',['projects','sharing','imports','integrations','settings','operations']]] as const;
function currentRoute(){const key=location.hash.slice(1).split('?')[0];if(key==='spaces')return 'sharing';return routes.some(r=>r[0]===key)?key:'overview';}
