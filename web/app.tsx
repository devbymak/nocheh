...
import {Activity as ActivityIcon,Archive as ArchiveIcon,ArrowUpRight,BrainCircuit,Database,FolderInput,FolderKanban,Share2,GitFork,Home,Menu,PanelLeftClose,PanelLeftOpen,Plug,RefreshCw,Settings as SettingsIcon,ShieldCheck,Users,Wrench,X} from 'lucide-react';
...
const groups=[['Knowledge',['overview','archive','learned','entities','memory','honcho','graph']],['Operations',['monitoring','activity']],['Manage',['projects','sharing','imports','spaces','integrations','settings','operations']]] as const;
