...
export function Workflows({call,health,onSource}){
  ...
  return h(React.Fragment,null,
    h('section',{className:'n-panel'},h('div',{className:'n-result-heading'},h('h2',null,'Product workflows'),h('a',{href:'/inngest/runs',className:'n-text-link'},'Inngest execution history →')),
