...
export async function ownerSecurityRoute(pool:pg.Pool,principal:Reader,req:IncomingMessage,res:ServerResponse,url:URL,options:{separated?:boolean;preview?:(input:unknown)=>Promise<unknown>}={}) {
