...
const shapes:Record<string,Shape>={
  ...
  memory_access_settings:shape('control','destination',{destination:'text',suggestions:'text',notify_owner:'boolean',auto_followup:'boolean',request_ttl_seconds:'number',default_grant_mode:'text',revision:'number',updated_at:'date'},true),
  memory_access_requests:shape('control','id',{id:'text',request_hash:'text',source_reference:'json',destination:'text',source_scope:'text',logical_profile:'text',query_hash:'text',fact_id:'text',fact_revision:'number',proposal_reference:'json',binding:'json',relationship_path:'json',evidence:'json',state:'text',decision:'text',grant_id:'text',notification_action_id:'text',followup_action_id:'text',revision:'number',expires_at:'date',created_at:'date',updated_at:'date'},true),
  memory_fact_grants:shape('control','id',{id:'text',request_id:'text',destination:'text',fact_id:'text',fact_revision:'number',representation_reference:'json',binding:'json',guard_revision:'number',text_hash:'text',mode:'text',state:'text',revision:'number',expires_at:'date',delivery_action_id:'text',suspended_reason:'text',consumed_at:'date',revoked_at:'date',created_at:'date',updated_at:'date'},true),
  memory_access_decisions:shape('control','operation_id',{operation_id:'text',request_hash:'text',request_id:'text',grant_id:'text',decision:'text',revision:'number',created_at:'date'},true)
};
