...
| Hermes memory | Read native notes and history, including retired topic/policy profiles. |
| Memory access | Set group/topic policies, approve exact shared text, search private knowledge and manage native review jobs. |
