(() => {
  ...
  function SpaceControls() {
    ...
    useEffect(()=>{let alive=true;import('/dashboard-plugins/nocheh/space-controls.js').then(m=>{if(alive)setComponent(()=>m.createSpaceControls(sdk.React,call));}).catch(e=>{if(alive)setError(errorText(e));});return()=>{alive=false;};},[]);
