...
- **Inngest — accepted implementation:** [workflow execution plan](docs/workflow-monitoring-plan.md), I1–I7. Local orchestration infrastructure, imports, controlled tools, approved messages and memory review are active; other family ownership switches remain pending. Independent host recovery and existing provider/Honcho/release gates apply.
