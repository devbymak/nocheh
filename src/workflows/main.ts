...
const operations={...pipelineOperations(pool,config,runtime),...memoryOperations(pool,config,runtime,honchoClient(config.honchoUrl)),...approvalOperations(pool,runtime)};
