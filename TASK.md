...
| Inngest workflows | I1 infrastructure/recovery and I2 transactional outbox, permanent registry, receipt and fencing primitives verified in isolated Compose. Product functions, binding job operations to fences, worker health and remaining I2–I7 work are pending; no active family switched. | [Foundation evidence](compatibility/results/2026-09-12-inngest-foundation.json), [Outbox evidence](compatibility/results/2026-09-12-inngest-outbox.json), [execution plan](docs/workflow-monitoring-plan.md) |
